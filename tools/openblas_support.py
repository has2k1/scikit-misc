# Ref: https://github.com/scipy/scipy/blob/main/tools/openblas_support.py
import glob
import os
import platform
import sysconfig
...
def test_version(expected_version, ilp64=get_ilp64()):
    ...
    """
    pass
    from skmisc.loess import _loess
    import ctypes

    dll = ctypes.CDLL(_loess.__file__)
    if ilp64 == "64_":
